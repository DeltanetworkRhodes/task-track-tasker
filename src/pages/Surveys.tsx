...
import { Eye, Calendar, MapPin, User, MessageSquare, FileImage, Image, FileText, Download } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4 text-sm">
          <span className="text-muted-foreground">
            Σύνολο: <strong className="text-foreground">{filtered.length}</strong>
          </span>
        </div>

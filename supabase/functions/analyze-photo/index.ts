...
ΒΗΜΑ 2 – ΑΞΙΟΛΟΓΗΣΗ ΠΟΙΟΤΗΤΑΣ (score 1-10):
  10/10 BENCHMARK (τέλεια εργασία):
    • Open Trench: Σωλήνες ξεκάθαρα ορατοί, ίσια στοίχιση, σωστό βάθος, καθαρές άκρες τομής
    • Warning Tape: Ταινία ξεκάθαρα ορατή σε ΟΛΟ το μήκος, απλωμένη επίπεδα
    • Base Layer: Τούβλα ομοιόμορφα, χωρίς κενά, πλήρης κάλυψη
    • Final Surface: Τέλεια ευθυγράμμιση, καμία ρωγμή, καθαρή, ταιριάζει με περιβάλλον
  7-9: Καλή εργασία με μικρές ατέλειες
  4-6: Λείπουν ΚΡΙΣΙΜΑ στοιχεία ή χαμηλή ποιότητα

...
- Λευκά κανάλια (12x12, 16x16, 25x25) σε εσωτερικό χώρο (τοίχο/οροφή/κλιμακοστάσιο)
- Γκρι σπιράλ σωληνώσεις (Φ16, Φ20, Φ25) σε εξωτερικό χώρο (KOUVIDIS ή παρόμοιο)
- Στηρίγματα τύπου Ω που συγκρατούν σωληνώσεις
- Καλώδιο οπτικής ίνας σε κάγκελο κλιμακοστασίου
- Κανάλι στο φανάρι κλιμακοστασίου
- Σωλήνα/σπιράλ σε φωταγωγό ή ακάλυπτο
- Εναέριο καλώδιο (αυτοστήρικτο) από στύλο ΟΤΕ σε κτίριο με κρίκους
- Μούφες σύνδεσης σωληνώσεων (ΟΧΙ μονωτική ταινία)
- Πλαστικές γωνίες σύνδεσης
ΤΕΧΝΙΚΑ ΚΡΙΤΗΡΙΑ ΠΟΙΟΤΗΤΑΣ:
- Τα κανάλια πρέπει να είναι ΛΕΥΚΑ (ασπρα) - σε εσωτερικούς χώρους
- Τα σπιράλ πρέπει να είναι ΓΚΡΙ - σε εξωτερικούς χώρους
- ΠΡΕΠΕΙ να είναι ΙΣΙΑ και ΕΥΘΕΙΑ - ΟΧΙ στραβά ή λυγισμένα
- ΔΕΝ πρέπει να είναι σπασμένα ή ραγισμένα
- ΔΕΝ πρέπει να κρέμονται ή να αιωρούνται - πρέπει να είναι σωστά στερεωμένα
- Η όδευση πρέπει να γίνεται στο ύψος ταβανιού
- Κανάλια ΜΟΝΟ σε εσωτερικούς χώρους, σωληνώσεις ΜΟΝΟ σε εξωτερικούς
- ΔΕΝ πρέπει να υπάρχει πρόσμιξη υλικών (κανάλι + σωλήνα μαζί)
- Στηρίγματα Ω ανά 40-50cm, ΟΧΙ ρόκες ή tie wraps για στήριξη
- Γωνίες ≤ 90°, χωρίς κενά στα κανάλια, καπάκια στα τελειώματα
ΑΠΟΡΡΙΨΗ αν: δεν φαίνεται καμία καλωδίωση/σωλήνωση/κανάλι, τα κανάλια/σπιράλ είναι σπασμένα ή κρέμονται, ή είναι εντελώς άσχετη.`,

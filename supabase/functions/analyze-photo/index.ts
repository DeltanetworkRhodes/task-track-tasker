...
- Τομή κομμένη στο πεζοδρόμιο/μπετόν (ευθεία ή γωνιακή/Γ-σχήμα)
- Μαύρος σωλήνας HDPE ή/και μπλε σωλήνας τοποθετημένος στον πάτο
- Γκρι σωληνώσεις (σιδηροσπιράλ) μπορεί να φαίνονται
- Σκάβουμε σε βάθος 40cm και πλάτος 50cm
- Πάντα σιδηροσπιράλ ή σωλήνα HDPE – σε καμία περίπτωση σκέτο σωληνάκι
- Η σιδηροσωλήνα πρέπει να εφάπτει στο έδαφος
- Απαιτούνται 2 σωληνίσκοι (ΚΥΑ): 7/4 για τη δική μας ίνα + 14/10 ή 12/10 ή 10/8 για δεύτερο πάροχο (εξαιρούνται κτήρια με BCP)

ΦΑΣΗ 2 – ΤΟΥΒΛΑ ΠΡΟΣΤΑΣΙΑΣ:
- Κόκκινα/πορτοκαλί τούβλα (τύπου κεραμίδι/πλάκα) τοποθετημένα ΟΡΙΖΟΝΤΙΑ πάνω από τον σωλήνα
- Τα τούβλα καλύπτουν ομοιόμορφα ΟΛΟ το μήκος του σωλήνα, σε σειρά

ΦΑΣΗ 3 – ΚΙΤΡΙΝΟ/ΠΟΡΤΟΚΑΛΙ ΠΛΕΓΜΑ ΣΗΜΑΝΣΗΣ (WARNING TAPE):
- Πορτοκαλί/κίτρινο πλαστικό πλέγμα/δίχτυ/ταινία προειδοποίησης τοποθετημένο ΠΑΝΩ από τα τούβλα
- ΚΡΙΣΙΜΟ: Η ταινία σήμανσης είναι ΥΠΟΧΡΕΩΤΙΚΗ σε κάθε χωματουργικό
- Πρέπει να καλύπτει ολόκληρο το μήκος του σκάμματος
- Σκοπός: σήμανση για μελλοντικές εκσκαφές ότι υπάρχει δίκτυο από κάτω
- ΑΝ ΛΕΙΠΕΙ → feedbackForTechnician: "Λείπει το κίτρινο/πορτοκαλί πλέγμα σήμανσης – υποχρεωτικό σύμφωνα με τις προδιαγραφές"
...
- Οι πλάκες πεζοδρομίου πρέπει να αντικατασταθούν με καινούριες – ΔΕΝ σπάμε κράσπεδο

ΤΕΧΝΙΚΑ ΚΡΙΤΗΡΙΑ ΠΟΙΟΤΗΤΑΣ:
- Η τομή μπορεί να είναι ευθεία ή γωνιακή (Γ/L σχήμα)

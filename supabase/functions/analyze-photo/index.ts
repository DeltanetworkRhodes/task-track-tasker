...
- Λευκά πλαστικά κανάλια (οποιουδήποτε μεγέθους) σε τοίχο/ταβάνι
- Γκρι σπιράλ σωληνώσεις (κουβίδι/KOUVIDIS ή παρόμοιο)
- Ευθεία σωλήνα PVC (λευκή ή γκρι)
- Εναέριο καλώδιο (αυτοστήρικτο) από στύλο σε κτίριο
- Κουτιά διακλάδωσης (junction boxes) στα σημεία αλλαγής κατεύθυνσης
- Πριζάκι οπτικής ίνας (FB/Floor Box) στον τοίχο

ΣΗΜΑΝΤΙΚΟ - ΕΛΕΓΧΟΣ ΠΟΙΟΤΗΤΑΣ ΕΡΓΑΣΙΑΣ:
- Αρκεί να φαίνεται ΟΠΟΙΟΔΗΠΟΤΕ στοιχείο όδευσης (κανάλι, σπιράλ, σωλήνα, καλώδιο)
- ΔΕΝ μας ενδιαφέρει αν φαίνονται ανοιχτά κουτιά (BEP, BMO, BCP) στη φωτογραφία – αυτά ελέγχονται στην κατηγορία ΚΟΛΛΗΣΗ
- Κάθε φωτογραφία μπορεί να δείχνει ένα μικρό τμήμα της όδευσης – ΑΠΟΔΕΚΤΟ
- Μπορεί να φαίνεται κλιμακοστάσιο, πιλοτή, πρόσοψη, ακάλυπτος – όλα ΑΠΟΔΕΚΤΑ

ΚΡΙΤΗΡΙΑ ΠΟΙΟΤΗΤΑΣ (σαν να το βλέπει ανθρώπινο μάτι):
- Τα κανάλια (λευκά) πρέπει να είναι ΙΣΙΑ και ΟΜΟΙΟΜΟΡΦΑ – σε ευθεία γραμμή, χωρίς στραβά σημεία
- Τα σπιράλ (γκρι κουβίδι) πρέπει να είναι ΟΜΟΡΦΑ ΠΕΡΑΣΜΕΝΑ – ομαλά, χωρίς κυματισμούς, χωρίς βρόχους
- Η δουλειά πρέπει να φαίνεται ΕΠΑΓΓΕΛΜΑΤΙΚΗ – σαν να τη βλέπεις και λες "ωραία δουλειά"
- Αν κανάλι/σπιράλ είναι στραβό, κάνει ζιγκ-ζαγκ, κρέμεται, ή φαίνεται τσαπατσούλικο → ΧΑΜΗΛΟ SCORE
- Αν τα περάσματα είναι καθαρά, ευθύγραμμα, τακτοποιημένα → ΥΨΗΛΟ SCORE

ΕΓΚΡΙΣΗ (score >= 7) αν:
- Φαίνεται έστω ΕΝΑ κανάλι, σπιράλ, σωλήνα ή καλώδιο τοποθετημένο σε τοίχο/ταβάνι/πρόσοψη
- Η εγκατάσταση φαίνεται ΤΑΚΤΟΠΟΙΗΜΕΝΗ και ΕΥΘΥΓΡΑΜΜΗ

ΑΠΟΡΡΙΨΗ (score < 7) αν:
- Δεν φαίνεται ΚΑΜΙΑ ΑΠΟΛΥΤΩΣ σωλήνωση/κανάλι/σπιράλ/καλώδιο
- Είναι εντελώς άσχετη φωτογραφία (φαγητό, selfie, ζώο κλπ)
- Τα κανάλια/σπιράλ είναι ΣΤΡΑΒΑ, ΑΝΟΜΟΙΟΜΟΡΦΑ ή φαίνεται κακή εγκατάσταση
- Δείχνει ΜΟΝΟ σκάμμα χωρίς κανένα στοιχείο όδευσης`,

...
ΠΡΕΠΕΙ να φαίνεται η ΣΩΣΤΗ ΔΙΑΣΤΡΩΜΑΤΩΣΗ (από κάτω προς τα πάνω):
1. Τομή/εκσκαφή στο πεζοδρόμιο ή άσφαλτο (~30x30 εκατοστά)
2. Μαύρος σωλήνας (σιδηροσπιράλ/HDPE) στον πάτο του σκάμματος
3. Τούβλα τοποθετημένα πάνω από τον σωλήνα (προστασία)
4. Πορτοκαλί πλέγμα/δίχτυ σήμανσης πάνω από τα τούβλα
5. Μπετόν/τσιμέντο αποκατάστασης στην κορυφή (κλείσιμο σκάμματος)
ΤΕΧΝΙΚΑ ΚΡΙΤΗΡΙΑ ΠΟΙΟΤΗΤΑΣ:
- Η τομή πρέπει να είναι ~30x30cm (ή κοντά σε αυτές τις διαστάσεις)
- Ο μαύρος σωλήνας πρέπει να είναι σταθερά τοποθετημένος στον πάτο
- Τα τούβλα πρέπει να καλύπτουν ομοιόμορφα τον σωλήνα
- Το πορτοκαλί πλέγμα/δίχτυ πρέπει να είναι ορατό ως ενδιάμεσο στρώμα
- Η αποκατάσταση (μπετόν) πρέπει να είναι ομαλή και στο επίπεδο του πεζοδρομίου
- ΔΕΝ πρέπει να έχει σπάσει κράσπεδο
- Οι πλάκες πεζοδρομίου πρέπει να αντικατασταθούν σωστά
ΑΠΟΡΡΙΨΗ αν: δεν φαίνεται κανένα σκάμμα/εκσκαφή/σωληνώσεις, λείπουν κρίσιμα στρώματα (τούβλα, πλέγμα, μπετόν), είναι εσωτερικός χώρος κτιρίου, ή είναι άσχετη.`,

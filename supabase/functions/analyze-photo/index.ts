...
ΒΗΜΑ 3 – CONTEXTUAL VALIDATION:
  Αναγνώρισε τη ΦΑΣΗ ΕΡΓΑΣΙΑΣ – αλλά να είσαι λογικός, όχι υπερβολικά αυστηρός.
  • Αν ο τεχνικός ανεβάζει στην κατηγορία "Αποκατάσταση" αλλά βλέπεις ανοιχτή τρύπα → isApproved = false (αυτό ΕΙΝΑΙ λάθος)
  • Αν βλέπεις σωλήνα και η τομή είναι λίγο ακατάστατη → score 6-7 (ΟΧΙ απόρριψη, απλά σχόλιο)
  • Αν λείπει το πλέγμα σήμανσης στη φάση "Warning Tape" → score 5-6, σχόλιο ότι λείπει

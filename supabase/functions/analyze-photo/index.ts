...
const CONSTRUCTION_CATEGORY_PROMPTS: Record<string, string> = {
  ΣΚΑΜΑ:
    `Ελέγξτε αν η φωτογραφία δείχνει ΣΚΑΜΑ (χωματουργικό/εκσκαφή) για δίκτυο FTTH Β' Φάσης.
ΠΡΕΠΕΙ να φαίνεται ΤΟΥΛΑΧΙΣΤΟΝ ΕΝΑ από τα εξής:
- Εκσκαφή/τάφρος/χαντάκι σε πεζοδρόμιο ή άσφαλτο (βάθος ~40cm, πλάτος ~50cm)
- Σιδηροσπιράλ ή σωλήνα HDPE μέσα σε σκάμμα
- Σωληνίσκος 7/4mm ή 14/10mm μέσα σε σιδηροσπιράλ
- Μπάλα εντοπισμού ή αναμονή σωληνίσκου
- Πολυσωλήνιο Α' φάσης (απομάστευση)
- Τούβλα, ταινία σήμανσης ή πλάκες πεζοδρομίου κατά τη διάρκεια εργασιών
- Φρεάτιο ή μούφα (straight connector) σύνδεσης σωληνίσκων
- Τσιμέντο/αποκατάσταση πεζοδρομίου μετά την εκσκαφή
ΤΕΧΝΙΚΑ ΚΡΙΤΗΡΙΑ ΠΟΙΟΤΗΤΑΣ:
- Ο σωληνίσκος ΠΡΕΠΕΙ να είναι μέσα σε σιδηροσπιράλ/HDPE, ποτέ σκέτος
- Η σιδηροσωλήνα πρέπει να εφάπτει στο έδαφος
- Πρέπει να υπάρχει ταινία σήμανσης πάνω από το σιδηροσπιράλ
- ΔΕΝ πρέπει να έχει σπάσει κράσπεδο (σκάβουμε κάτω από αυτό)
- Οι πλάκες πεζοδρομίου πρέπει να αντικατασταθούν
ΑΠΟΡΡΙΨΗ αν: δεν φαίνεται κανένα σκάμμα/εκσκαφή/σωληνώσεις, είναι εσωτερικός χώρος κτιρίου, ή είναι άσχετη.`,

  ...
  try {
    ...
    const emailHtml = `
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f5f7fa;">
        <div style="background: linear-gradient(135deg, #dc2626, #991b1b); color: white; padding: 24px 28px; border-radius: 12px 12px 0 0;">
          <div style="display: flex; align-items: center; gap: 10px;">
            <span style="font-size: 24px;">❌</span>
            <div>
              <h2 style="margin: 0; font-size: 18px; font-weight: 700; letter-spacing: 0.3px;">ΑΚΥΡΩΣΗ</h2>
        ...
        <div style="background: white; border: 1px solid #d1d9e0; border-top: none; padding: 28px; border-radius: 0 0 12px 12px;">
          ...
          <p style="color: #4a5568; font-size: 14px; line-height: 1.7; margin: 0 0 20px;">
            Σας ενημερώνουμε ότι ο τεχνικός <strong style="color: #1a2332;">${escapeHtml(techName)}</strong> ακύρωσε το <strong style="color: #1a2332;">SR: ${escapeHtml(sr_id)}</strong>.
          </p>
          ...
          <div style="background: #fef2f2; border-left: 4px solid #dc2626; padding: 14px 18px; margin: 20px 0; border-radius: 0 8px 8px 0;">
            <p style="font-weight: 700; color: #1a2332; font-size: 13px; margin: 0 0 6px;">📝 Λόγος Ακύρωσης:</p>
            <p style="color: #4a5568; font-size: 14px; margin: 0; line-height: 1.6;">${escapeHtml(cancellation_reason)}</p>
          </div>
